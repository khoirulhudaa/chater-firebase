import { authSignIn, authSignOut, saveToken } from "@/redux/authSlice";
        ...
        <div className="bg-gray-100 flex items-center justify-center min-h-screen">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full md:w-[40vw]">
                ...
                <p className="text-gray-600 mb-6">
                    Pilih salah satu cara masuk
                </p>
                <form>
                    <div className="mb-4">
                        <label htmlFor="Nama pengguna"></label>
                        <input value={username} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setUsername(e.target.value)} className="w-full text-black p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Muhammad Khoirulhuda" type="email" />
                    </div>
                    <div className="mb-6">
                    ...
                    <p className="text-gray-600 text-[14px] mb-4">
                        Belum punya akun? <Link className="text-blue-500" href={'/auth/register'}>daftar</Link>
                    </p>
